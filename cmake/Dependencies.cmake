...
if(USE_OPENMP)
  ...
  list(APPEND Caffe_LINKER_LIBS ${OpenMP_CXX_FLAGS})
...
# ---[ OpenCV
if(USE_OPENCV)
  find_package(OpenCV QUIET COMPONENTS core highgui imgproc imgcodecs video videoio)
  if(NOT OpenCV_FOUND) # if not OpenCV 3.x, then imgcodecs are not found
    find_package(OpenCV REQUIRED COMPONENTS core highgui imgproc video videoio)
  endif()
