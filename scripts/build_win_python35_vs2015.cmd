...
if DEFINED APPVEYOR (
    ...
    :: if NOT DEFINED CUDA_ARCH_NAME set CUDA_ARCH_NAME=Auto
	if NOT DEFINED CUDA_ARCH_NAME set CUDA_ARCH_NAME=Kepler
...
set batch_file=C:\Program Files (x86)\Microsoft Visual Studio 14.0\VC\Auxiliary\Build\vcvarsall.bat
